...
public class MainDo implements Service{
	...
	public void newBookInit(ArrayList<Book> newBookList) {
		...
		book.setImage_path("/BookStore/images/종이여자.jpeg");
		...
		book.setImage_path("/BookStore/images/구해줘.jpeg");
		newBookList.add(book);
		...
		book.setImage_path("/BookStore/images/센트럴파크.jpeg");
		newBookList.add(book);
		...
		book.setAuthor("기욤 뮈소");
		book.setPrice("30,000");
		book.setImage_path("/BookStore/images/브루클린의_소녀.jpeg");
		newBookList.add(book);
		...
		book.setPrice("31,500");
		book.setImage_path("/BookStore/images/제0호.jpeg");
		newBookList.add(book);
	}
	...
	public void hotBookInit(ArrayList<Book> hotBookList) {
		...
		book.setImage_path("/BookStore/images/12가지_인생의_법칙.jpg");
		hotBookList.add(book);
		...
		book.setImage_path("/BookStore/images/트렌드_코리아_2019.jpg");
		hotBookList.add(book);
		...
		book.setImage_path("/BookStore/images/걷는_사람_하정우.jpg");
		hotBookList.add(book);
		...
		book.setImage_path("/BookStore/images/고요할수록_밝아지는_것들.jpg");
		hotBookList.add(book);
		...
		book.setImage_path("/BookStore/images/아가씨와_밤.jpg");
		hotBookList.add(book);
		...
		book.setImage_path("/BookStore/images/당신이_옳다.jpg");
		hotBookList.add(book);
	}
}
