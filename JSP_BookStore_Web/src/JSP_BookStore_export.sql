--------------------------------------------------------
--  파일이 생성됨 - 금요일-12월-14-2018   
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Table BOOK_BOARD
--------------------------------------------------------

  CREATE TABLE "JEONGNAMBOOKSTORE"."BOOK_BOARD" 
   (	"BOARD_ID" NUMBER, 
	"CONTEXT" NVARCHAR2(2000), 
	"READCNT" NUMBER, 
	"BOOK_CODE" NUMBER, 
	"CATEGORY_ID" NUMBER, 
	"DELETE_STATUS" NUMBER(1,0) DEFAULT 0
...
--------------------------------------------------------
  ...
  CREATE TABLE "JEONGNAMBOOKSTORE"."BOOKS" 
   (	"BOOK_CODE" NUMBER, 
	"TITLE" NVARCHAR2(100), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "JEONGNAMBOOKSTORE"."CARTS" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "JEONGNAMBOOKSTORE"."CATEGORYS" 
   (	"CATEGORY_ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "JEONGNAMBOOKSTORE"."DIBS" 
   (	"USER_ID" NVARCHAR2(20), 
	"BOOK_CODE" NUMBER
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
...
--------------------------------------------------------
  ...
  CREATE TABLE "JEONGNAMBOOKSTORE"."ORDER_INFO" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "JEONGNAMBOOKSTORE"."ORDER_STATUS" 
   (	"STATUS" NVARCHAR2(20)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
--------------------------------------------------------
  ...
  CREATE TABLE "JEONGNAMBOOKSTORE"."ORDERS" 
   (	"ORDER_CODE" VARCHAR2(40 BYTE), 
	"USER_ID" NVARCHAR2(20), 
	"STATUS" NVARCHAR2(20), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "JEONGNAMBOOKSTORE"."PERMISSIONS" 
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table RECOMMENTS
--------------------------------------------------------

  CREATE TABLE "JEONGNAMBOOKSTORE"."RECOMMENTS" 
   (	"RECOMMENT_ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "JEONGNAMBOOKSTORE"."USERS" 
   (	"USER_ID" NVARCHAR2(20), 
	"USER_PW" NVARCHAR2(20), 
	"NAME" NVARCHAR2(10), 
	...
	"ACCEPT_STATUS" NUMBER(1,0) DEFAULT 0, 
	"PERMISSION" VARCHAR2(50 BYTE)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
REM INSERTING into JEONGNAMBOOKSTORE.CARTS
SET DEFINE OFF;
...
REM INSERTING into JEONGNAMBOOKSTORE.DIBS
SET DEFINE OFF;
REM INSERTING into JEONGNAMBOOKSTORE.ORDER_INFO
SET DEFINE OFF;
REM INSERTING into JEONGNAMBOOKSTORE.ORDER_STATUS
SET DEFINE OFF;
REM INSERTING into JEONGNAMBOOKSTORE.ORDERS
SET DEFINE OFF;
...
REM INSERTING into JEONGNAMBOOKSTORE.RECOMMENTS
SET DEFINE OFF;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "JEONGNAMBOOKSTORE"."SYS_C009039" ON "JEONGNAMBOOKSTORE"."BOOK_BOARD" ("BOARD_ID") 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "JEONGNAMBOOKSTORE"."SYS_C009097" ON "JEONGNAMBOOKSTORE"."BOOK_BOARD" ("BOOK_CODE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "JEONGNAMBOOKSTORE"."SYS_C009034" ON "JEONGNAMBOOKSTORE"."BOOKS" ("BOOK_CODE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "JEONGNAMBOOKSTORE"."SYS_C009045" ON "JEONGNAMBOOKSTORE"."CATEGORYS" ("CATEGORY_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "JEONGNAMBOOKSTORE"."SYS_C009048" ON "JEONGNAMBOOKSTORE"."DIBS" ("USER_ID", "BOOK_CODE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "JEONGNAMBOOKSTORE"."SYS_C009056" ON "JEONGNAMBOOKSTORE"."ORDER_INFO" ("ORDER_CODE", "BOOK_CODE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index SYS_C009058
--------------------------------------------------------

  CREATE UNIQUE INDEX "JEONGNAMBOOKSTORE"."SYS_C009058" ON "JEONGNAMBOOKSTORE"."ORDER_STATUS" ("STATUS") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index SYS_C009052
--------------------------------------------------------

  CREATE UNIQUE INDEX "JEONGNAMBOOKSTORE"."SYS_C009052" ON "JEONGNAMBOOKSTORE"."ORDERS" ("ORDER_CODE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "JEONGNAMBOOKSTORE"."SYS_C009060" ON "JEONGNAMBOOKSTORE"."PERMISSIONS" ("PERMISSION") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index SYS_C009066
--------------------------------------------------------

  CREATE UNIQUE INDEX "JEONGNAMBOOKSTORE"."SYS_C009066" ON "JEONGNAMBOOKSTORE"."RECOMMENTS" ("RECOMMENT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "JEONGNAMBOOKSTORE"."SYS_C009077" ON "JEONGNAMBOOKSTORE"."USERS" ("USER_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index SYS_C009078
--------------------------------------------------------

  CREATE UNIQUE INDEX "JEONGNAMBOOKSTORE"."SYS_C009078" ON "JEONGNAMBOOKSTORE"."USERS" ("SSN") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "JEONGNAMBOOKSTORE"."BOOK_BOARD" ADD UNIQUE ("BOOK_CODE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "JEONGNAMBOOKSTORE"."BOOK_BOARD" ADD PRIMARY KEY ("BOARD_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "JEONGNAMBOOKSTORE"."BOOK_BOARD" MODIFY ("DELETE_STATUS" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."BOOK_BOARD" MODIFY ("BOOK_CODE" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."BOOK_BOARD" MODIFY ("CONTEXT" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."BOOK_BOARD" MODIFY ("BOARD_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table BOOKS
--------------------------------------------------------

  ALTER TABLE "JEONGNAMBOOKSTORE"."BOOKS" ADD PRIMARY KEY ("BOOK_CODE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "JEONGNAMBOOKSTORE"."BOOKS" MODIFY ("DELETE_STATUS" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."BOOKS" MODIFY ("PUBLISHER" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."BOOKS" MODIFY ("STOCK" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."BOOKS" MODIFY ("PRICE" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."BOOKS" MODIFY ("AUTHOR" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."BOOKS" MODIFY ("TITLE" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."BOOKS" MODIFY ("BOOK_CODE" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table CARTS
--------------------------------------------------------

  ALTER TABLE "JEONGNAMBOOKSTORE"."CARTS" MODIFY ("WISH_STOCK" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."CARTS" MODIFY ("BOOK_CODE" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."CARTS" MODIFY ("USER_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table CATEGORYS
--------------------------------------------------------

  ALTER TABLE "JEONGNAMBOOKSTORE"."CATEGORYS" ADD PRIMARY KEY ("CATEGORY_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "JEONGNAMBOOKSTORE"."CATEGORYS" MODIFY ("CATEGORY_NAME" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."CATEGORYS" MODIFY ("CATEGORY_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table DIBS
--------------------------------------------------------

  ALTER TABLE "JEONGNAMBOOKSTORE"."DIBS" ADD PRIMARY KEY ("USER_ID", "BOOK_CODE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "JEONGNAMBOOKSTORE"."DIBS" MODIFY ("BOOK_CODE" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."DIBS" MODIFY ("USER_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table ORDER_INFO
--------------------------------------------------------

  ALTER TABLE "JEONGNAMBOOKSTORE"."ORDER_INFO" ADD PRIMARY KEY ("ORDER_CODE", "BOOK_CODE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "JEONGNAMBOOKSTORE"."ORDER_INFO" MODIFY ("BUY_STOCK" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."ORDER_INFO" MODIFY ("BOOK_CODE" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."ORDER_INFO" MODIFY ("ORDER_CODE" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table ORDER_STATUS
--------------------------------------------------------

  ALTER TABLE "JEONGNAMBOOKSTORE"."ORDER_STATUS" ADD PRIMARY KEY ("STATUS")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "JEONGNAMBOOKSTORE"."ORDER_STATUS" MODIFY ("STATUS" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table ORDERS
--------------------------------------------------------

  ALTER TABLE "JEONGNAMBOOKSTORE"."ORDERS" ADD PRIMARY KEY ("ORDER_CODE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "JEONGNAMBOOKSTORE"."ORDERS" MODIFY ("STATUS" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."ORDERS" MODIFY ("USER_ID" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."ORDERS" MODIFY ("ORDER_CODE" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table PERMISSIONS
--------------------------------------------------------

  ALTER TABLE "JEONGNAMBOOKSTORE"."PERMISSIONS" ADD PRIMARY KEY ("PERMISSION")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "JEONGNAMBOOKSTORE"."PERMISSIONS" MODIFY ("PERMISSION" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table RECOMMENTS
--------------------------------------------------------

  ALTER TABLE "JEONGNAMBOOKSTORE"."RECOMMENTS" ADD PRIMARY KEY ("RECOMMENT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "JEONGNAMBOOKSTORE"."RECOMMENTS" MODIFY ("DELETE_STATUS" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."RECOMMENTS" MODIFY ("P_ID" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."RECOMMENTS" MODIFY ("BOARD_ID" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."RECOMMENTS" MODIFY ("CONTENT" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."RECOMMENTS" MODIFY ("RECOMMENT_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table USERS
--------------------------------------------------------

  ALTER TABLE "JEONGNAMBOOKSTORE"."USERS" ADD UNIQUE ("SSN")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "JEONGNAMBOOKSTORE"."USERS" ADD PRIMARY KEY ("USER_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "JEONGNAMBOOKSTORE"."USERS" MODIFY ("PERMISSION" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."USERS" MODIFY ("ACCEPT_STATUS" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."USERS" MODIFY ("DELETE_STATUS" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."USERS" MODIFY ("PHONE_NUMBER" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."USERS" MODIFY ("ADDRESS1" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."USERS" MODIFY ("ZIPCODE" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."USERS" MODIFY ("EMAIL" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."USERS" MODIFY ("SSN" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."USERS" MODIFY ("USER_PW" NOT NULL ENABLE);
  ALTER TABLE "JEONGNAMBOOKSTORE"."USERS" MODIFY ("USER_ID" NOT NULL ENABLE);
